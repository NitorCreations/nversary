...
it("Sends message special message on 5 year nversary", async () => {
  ...
  const congratulationDay = new CongratulationDay(now);
  congratulationDay.employees = [
    new Employee("Erkki Esimerkki", "asd@asd.com", [new Presence(new Date("2015-02-06"))], "Senior Architect", "Software Company Oy")
  ];
  anniversaryService.getEmployeesToCongratulateToday = jest.fn((date: Date, maxPerDay: number) => congratulationDay);
...
it("Sends message special message on 10 year nversary", async () => {
  ...
  const congratulationDay = new CongratulationDay(now);
  congratulationDay.employees = [
    new Employee("Erkki Esimerkki", "asd@asd.com", [new Presence(new Date("2010-02-06"))], "Senior Architect", "Software Company Oy")
  ];
  anniversaryService.getEmployeesToCongratulateToday = jest.fn((date: Date, maxPerDay: number) => congratulationDay);
...
it("Sends one extra emoji for 6-9 year nversary", async () => {
  ...
  const congratulationDay = new CongratulationDay(now);
  congratulationDay.employees = [
    new Employee("Erkki Esimerkki", "asd@asd.com", [new Presence(new Date("2012-02-06"))], "Senior Architect", "Software Company Oy")
  ];
  anniversaryService.getEmployeesToCongratulateToday = jest.fn((date: Date, maxPerDay: number) => congratulationDay);
...
it("Sends two extra emojis for 10+ year nversary", async () => {
  ...
  const congratulationDay = new CongratulationDay(now);
  congratulationDay.employees = [
    new Employee("Erkki Esimerkki", "asd@asd.com", [new Presence(new Date("2009-02-06"))], "Senior Architect", "Software Company Oy")
  ];
  anniversaryService.getEmployeesToCongratulateToday = jest.fn((date: Date, maxPerDay: number) => congratulationDay);
